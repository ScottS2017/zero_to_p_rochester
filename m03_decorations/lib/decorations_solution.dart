...
class DecorationsSolution extends StatelessWidget {
  const DecorationsSolution({Key key}) : super(key: key);
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  color: Colors.grey,
                  // TODO 15) Give it a DecorationImage with BoxFit.contain and for the image use an AssetImage called 'AppImages.f', without quotes
                  image: DecorationImage(
                    fit: BoxFit.contain,
                    image: AssetImage(AppImages.f),
                  ),
                ),
              ),
